...
class GeneticAlgorithmGUI(QtWidgets.QMainWindow):
    ...
    def calculate_chromosomes(self):
        ...
        self.genes = initialize_particles(area, num_genes)
    ...
    def calculate(self):
        ...
        self.spinBox_4.setValue(previous_iterations)
        lower_bound = self.spinBox_6.value()
        upper_bound = self.spinBox_7.value()
        area = (lower_bound, upper_bound)

        result = algorithm(deepcopy(self.genes), total_iterations, func_str, area)
