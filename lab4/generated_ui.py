...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.MutationPercentQLE = QtWidgets.QLineEdit(self.verticalLayoutWidget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.MutationPercentQLE.sizePolicy().hasHeightForWidth())
        self.MutationPercentQLE.setSizePolicy(sizePolicy)
        self.MutationPercentQLE.setObjectName("MutationPercentQLE")
        self.horizontalLayout_9.addWidget(self.MutationPercentQLE)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "Количество генов:"))
        self.label_8.setText(_translate("MainWindow", "Процент мутации:"))
